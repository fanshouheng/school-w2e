...
4. 班级信息要完整，例如："一年级2班"、"二年级4班"、"三年级1班"等，不要简写为"一2"、"二4"
5. 日期只在第一行的学校名称后添加，格式：学校名称（2025-09-14），其他行的学校名称不需要带日期
6. ${fileContents.length > 1 ? '请将所有文档中的信息合并到同一个表格中，按文档顺序排列' : ''}
...
1. 班级信息必须完整，如"一年级2班"、"二年级4班"，不要简写
2. 日期只在第一行学校名称后显示，其他行不重复显示日期
${fileContents.length > 1 ? '3. 请将所有文档的信息合并到一个统一的表格中' : ''}
